return {
	...
	Components = {
		...
		['at_pistolmk2_barrel'] = {
			label = 'Normal Barrel (Pistol MK2)',
			type = 'barrel',
			weight = 80,
			client = {
				component = {
					`COMPONENT_PISTOL_MK2_BARREL_NORMAL`,
				},
				usetime = 2500
			}
		},

		['at_pistolmk2_barrel_heavy'] = {
			label = 'Heavy Barrel (Pistol MK2)',
			type = 'barrel',
			weight = 180,
			client = {
				component = {
					`COMPONENT_PISTOL_MK2_BARREL_HEAVY`,
				},
				usetime = 2500
			}
		},

		['at_pistolmk2_ammo_ap'] = {
			label = 'Armor Piercing Rounds (Pistol MK2)',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_pistolmk2_ammo_hp'] = {
			label = 'Hollow Point Rounds (Pistol MK2)',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_pistolmk2_ammo_incendiary'] = {
			label = 'Incendiary Rounds (Pistol MK2)',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_pistolmk2_ammo_tracer'] = {
			label = 'Tracer Rounds (Pistol MK2)',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_pistolmk2_ammo_fmj'] = {
			label = 'FMJ Rounds (Pistol MK2)',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
					`COMPONENT_PISTOL_MK2_CLIP_HIGHVELOCITY`,
				},
				usetime = 2500
			}
		},

		['at_pistolmk2_ammo_explosive'] = {
			label = 'Explosive Rounds (Pistol MK2)',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
					`COMPONENT_PISTOL_MK2_CLIP_EXPLOSIVE`,
				},
				usetime = 2500
			}
		},
