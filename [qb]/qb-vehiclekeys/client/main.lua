...
-- robKeyLoop désactivé : pas de vol de clés, hotwiring, carjacking sur ce serveur PVP
-- Véhicule ouvert = tout le monde roule / Véhicule fermé = personne n'entre (natif GTA)
local function robKeyLoop() end
