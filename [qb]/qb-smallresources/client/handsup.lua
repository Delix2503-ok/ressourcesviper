do return end -- désactivé : serveur PVP, pas de roleplay
local handsUp = false
...
RegisterCommand(Config.HandsUp.command, function()
    ...
    handsUp = not handsUp
    if pcall(function() return exports['qb-policejob']:IsHandcuffed() end) and exports['qb-policejob']:IsHandcuffed() then return end
    if handsUp then
