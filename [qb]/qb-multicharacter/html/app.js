            ...
            create_character: function () {
                ...
                if (validationResult.isValid) {
                    ...
                    Swal.fire({
                        ...
                        background: "#0d1810",
                        color: "#c0eec0",
                        title: '<span style="color:#39FF14;font-family:Rajdhani,sans-serif;letter-spacing:2px">ERREUR</span>',
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    if (!this.autoSpawned) {
                                        ...
                                        if (this.autoShowCreation) {
                                            this.autoShowCreation = false;
                                            this.show.register = true;
                                        } else {
                                            this.show.characters = true;
                                        }
